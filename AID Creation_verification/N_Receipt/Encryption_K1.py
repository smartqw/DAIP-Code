...
start=time.time()
no_of_nominee=10
file_k1=open("user_k1.txt","rb")
key1=file_k1.read(32)
file_to_encrypt = "nominee_"+str(no_of_nominee)+".txt"
...
cipher_encrypt = AES.new(key1, AES.MODE_CFB)
...
# Create the cipher object and encrypt the data
cipher_encrypt = AES.new(key1, AES.MODE_CFB, iv=iv)
